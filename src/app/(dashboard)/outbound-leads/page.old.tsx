...
export default function OutboundLeadsPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.hasilKontakAwal) errors.hasilKontakAwal = 'Hasil Kontak Awal wajib dipilih'
    if (!formData.hasilAkhir) errors.hasilAkhir = 'Hasil Akhir wajib dipilih'
  ...
  const handleAddLead = () => {
    ...
    const newLead: OutboundLead = {
      ...
      hasilKontakAwal: formData.hasilKontakAwal as OutboundLead['hasilKontakAwal'],
      riwayatFollowUp: [],
      hasilAkhir: formData.hasilAkhir as OutboundLead['hasilAkhir'],
    ...
    resetForm()
    alert('Outbound lead berhasil ditambahkan!')
  }
  ...
  const handleEditLead = () => {
    ...
    setEditingLead(null)
    resetForm()
    alert('Outbound lead berhasil diupdate!')
  }
  ...
  const handleBulkDelete = () => {
    if (selectedRows.length === 0) {
      alert('Silakan pilih lead yang akan dihapus')
      return
    }
    ...
    if (confirm(`Apakah Anda yakin ingin menghapus ${selectedRows.length} lead?`)) {
      ...
      setSelectedRows([])
      alert('Lead terpilih berhasil dihapus!')
    }
  }
  ...
  const handleAddFollowUp = () => {
    if (!followUpLead || !followUpForm.catatan.trim()) {
      alert('Catatan follow-up wajib diisi')
      return
    }
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50 border-b-2 border-slate-200">
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[60px]">
                  <input
                    type="checkbox"
                ...
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[120px]">Tanggal Hubungi Pertama</TableHead>
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[200px]">Nama Faskes</TableHead>
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[140px]">No Kontak</TableHead>
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[120px]">Kota/Kabupaten</TableHead>
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[140px]">Status Kontak Awal</TableHead>
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[160px]">Hasil Kontak Awal</TableHead>
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[120px]">Hasil Akhir</TableHead>
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[150px]">RME Yang Digunakan</TableHead>
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-left min-w-[120px]">Follow Up</TableHead>
                <TableHead className="font-semibold text-slate-700 py-4 px-4 text-center min-w-[120px]">Aksi</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {paginatedLeads.map((lead) => (
                <TableRow key={lead.id} className="hover:bg-slate-50 border-b border-slate-100 transition-colors duration-200">
                  {/* Checkbox */}
                  ...
                  <TableCell className="py-4 px-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-sm font-medium text-slate-900">{lead.namaFaskes}</div>
                    </div>
                  </TableCell>
                  ...
                  {/* Hasil Kontak Awal */}
                  <TableCell className="py-4 px-4">
                    {getStatusBadge(lead.hasilKontakAwal, 'hasilKontak')}
                  </TableCell>

                  {/* Hasil Akhir */}
                  <TableCell className="py-4 px-4">
                    <div className="space-y-2">
                      {getStatusBadge(lead.hasilAkhir, 'hasilAkhir')}
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Hasil Kontak Awal <span className="text-red-500">*</span>
                    </label>
                    <select 
